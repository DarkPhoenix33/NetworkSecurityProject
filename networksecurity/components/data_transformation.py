...
class DataTransfomation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        logging.info(
            "Entered get_data_transformer_object method of Transforamtion class"
        )
        try:
    ...
    def initiate_data_tranforamtion(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_tranformation method DataTransformation class")
        try:
            ...
            target_feature_train_df=target_feature_train_df.replace(-1,0)        ### Transformed all -1 entries to 0 entries 
