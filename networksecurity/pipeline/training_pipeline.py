...
class TrainingPipeline:
    ...
    def start_data_transforamtion(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation=DataTransfomation(data_validation_artifact=data_validation_artifact,data_transformation_config=data_transforamtion_config)

            data_transforamtion_artifact=data_transformation.initiate_data_tranforamtion()
